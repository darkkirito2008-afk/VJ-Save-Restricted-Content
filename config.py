...
# Bot token @Botfather
BOT_TOKEN = os.environ.get("BOT_TOKEN", "8642173946:AAECP4OSifEKjCbuhK_VkfCQf8jcrMowK44")

# Your API ID from my.telegram.org
API_ID = int(os.environ.get("API_ID", "37833555"))

# Your API Hash from my.telegram.org
API_HASH = os.environ.get("API_HASH", "519811a97c16dc61b059d10996d1d442")
